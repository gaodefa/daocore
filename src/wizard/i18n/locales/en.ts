...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in DaoCore config",
    ...
    remote: {
      ...
      plaintextPasswordHint: "Stores the password directly in DaoCore config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in DaoCore config",
    ...
    security: {
      ...
      beta: "DaoCore is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run DaoCore.",
      learnMore: "Learn more",
      notMultitenant: "DaoCore is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, DaoCore is a personal agent: one trusted operator boundary.",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "DaoCore" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so DaoCore can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for DaoCore",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL DaoCore uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "DaoCore"',
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to DaoCore with full agent capabilities.",
    ...
    finalize: {
      ...
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control DaoCore.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control DaoCore.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control DaoCore.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control DaoCore.",
      outroSeeded:
